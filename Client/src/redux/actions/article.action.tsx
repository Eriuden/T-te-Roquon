...
export const updateArticle = ({
    ...
    price
        ...
        return axios({
            ...
            data: { name, typeArticle, licence, price},
        })
        .then(()=> {
            dispatch({
                type: UPDATE_ARTICLE,
                payload: {articleId, name, typeArticle, licence, price}
            })
        })
        .catch((err)=> window.alert(err))
}
...
export const deleteArticle = ({
    articleId, picture, name, typeArticle,licence, price
} : articlesProps, dispatch:any) => {
        return axios ({
            method:"delete",
            url:`${process.env.REACT_APP_API_URL}api/article/${articleId}`,
            data: {picture, name, typeArticle, licence, price}
        })
        .then(()=> {
